...
export default function PhotosUploader({ addedPhotos, onChange }) {
  ...
  // for remove photo from edit section
          ...
          addedPhotos.map((link) => (
            <div key={link} className="h-32 flex relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-50 rounded-2xl p-2 px-3"
              >
                <svg
